...
var day04_sample_board_raw = [][board_rows][board_cols]int{
	{
		{22, 13, 17, 11, 0},
		{8, 2, 23, 4, 24},
		{21, 9, 14, 16, 7},
...
var day04_data_board_raw = [][board_rows][board_cols]int{
	{
		{49, 74, 83, 34, 40},
		{87, 16, 57, 75, 3},
		{68, 94, 77, 78, 89},
...
func (gb *game_board) play_number(number int) bool {
	for r := 0; r < board_rows; r++ {
		for c := 0; c < board_cols; c++ {
